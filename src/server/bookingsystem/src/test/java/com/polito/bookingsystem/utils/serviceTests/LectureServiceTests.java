...
class LectureServiceTests {
	...
	void testGetProfessorLectures1() {
		//null email
		assertNull("Expected null, null email",lectureServiceImpl.getProfessorLectures(null));
	}
	...
	void testGetProfessorLectures2() {
		...
		assertNull("Expected null, null email", lectureServiceImpl.getProfessorLectures("wrong@email"));
	}
