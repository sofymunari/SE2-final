...
INSERT INTO LECTURE(LECTURE_ID,NUMBER_OF_LESSON,COURSE_ID,USER_ID,REMOTLY,DATE,DURATION,PROGRAM_DETAILS,ROOM_ID) VALUES (0,1,0,0,TRUE,'2020-11-30 10:00',180,'',0);
...
INSERT INTO LECTURE(LECTURE_ID,NUMBER_OF_LESSON,COURSE_ID,USER_ID,REMOTLY,DATE,DURATION,PROGRAM_DETAILS,ROOM_ID) VALUES (2,1,1,1,TRUE,'2020-12-03 14:00',180,'',1);
...
INSERT INTO LECTURE(LECTURE_ID,NUMBER_OF_LESSON,COURSE_ID,USER_ID,REMOTLY,DATE,DURATION,PROGRAM_DETAILS,ROOM_ID) VALUES (4,2,2,2,TRUE,'2020-12-01 08:00',90,'',3);
INSERT INTO LECTURE(LECTURE_ID,NUMBER_OF_LESSON,COURSE_ID,USER_ID,REMOTLY,DATE,DURATION,PROGRAM_DETAILS,ROOM_ID) VALUES (5,1,3,3,TRUE,'2020-12-03 16:30',90,'',4);
INSERT INTO LECTURE(LECTURE_ID,NUMBER_OF_LESSON,COURSE_ID,USER_ID,REMOTLY,DATE,DURATION,PROGRAM_DETAILS,ROOM_ID) VALUES (6,2,3,3,TRUE,'2020-12-04 14:00',90,'',1);
INSERT INTO LECTURE(LECTURE_ID,NUMBER_OF_LESSON,COURSE_ID,USER_ID,REMOTLY,DATE,DURATION,PROGRAM_DETAILS,ROOM_ID) VALUES (7,1,4,2,TRUE,'2020-11-30 14:00',90,'',2);
...
INSERT INTO LECTURE(LECTURE_ID,NUMBER_OF_LESSON,COURSE_ID,USER_ID,REMOTLY,DATE,DURATION,PROGRAM_DETAILS,ROOM_ID) VALUES (9,2,5,0,TRUE,'2020-12-03 12:30',90,'',0);
INSERT INTO LECTURE(LECTURE_ID,NUMBER_OF_LESSON,COURSE_ID,USER_ID,REMOTLY,DATE,DURATION,PROGRAM_DETAILS,ROOM_ID) VALUES (10,3,5,0,TRUE,'2020-12-07 14:00',90,'',4);
...
INSERT INTO BOOKING(BOOKING_ID, BOOKING_INFO, LECTURE_ID, USER_ID) VALUES (0,'WAITING',0,0);
INSERT INTO BOOKING(BOOKING_ID, BOOKING_INFO, LECTURE_ID, USER_ID) VALUES (1,'ATTENDED',2,3);
