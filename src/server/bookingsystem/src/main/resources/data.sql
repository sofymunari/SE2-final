...
INSERT INTO LECTURE(LECTURE_ID,NUMBER_OF_LESSON,COURSE_ID,USER_ID,REMOTLY,DATE,DURATION,PROGRAM_DETAILS,ROOM_ID,BOOKED_SEATS,DELETED) VALUES (0,1,0,0,FALSE,'2021-11-22 10:00',180,'',0,20, FALSE);
INSERT INTO LECTURE(LECTURE_ID,NUMBER_OF_LESSON,COURSE_ID,USER_ID,REMOTLY,DATE,DURATION,PROGRAM_DETAILS,ROOM_ID,BOOKED_SEATS,DELETED) VALUES (1,2,0,0,FALSE,'2021-11-23 12:30',180,'',0,5, FALSE);
INSERT INTO LECTURE(LECTURE_ID,NUMBER_OF_LESSON,COURSE_ID,USER_ID,REMOTLY,DATE,DURATION,PROGRAM_DETAILS,ROOM_ID,BOOKED_SEATS,DELETED) VALUES (2,1,1,1,FALSE,'2021-10-19 14:00',180,'',1,4, TRUE);
