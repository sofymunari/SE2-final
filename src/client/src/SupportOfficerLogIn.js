...
class SupportOfficerLogIn extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit = () => {
        if (!this.form.checkValidity()) {
            ...
            this.props.loginSupportOfficer(this.state.username,this.state.password);
    ...
    render() {
        return( <div className="row" >
                ...
                <div className="form-group">
                    <div>
                        <button type="submit" id="submit_button" className="btn btn-primary border-0 bg-success text-dark" onClick = {() => this.handleSubmit()}>LOGIN</button>
                    </div>
                </div>
                </form>
                </div>
...
export default SupportOfficerLogIn;