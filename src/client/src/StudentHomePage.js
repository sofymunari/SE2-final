...
function LectureItem (props){
    return (
        ...
        <div className="d-flex w-100 justify-content-between">
            ...
            <svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-cart-plus-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg" onClick={(ev) => props.addBooking(props.lecture.lecture_id)}>
